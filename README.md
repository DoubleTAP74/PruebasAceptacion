...
Siguiendo la práctica del curso (*Escribiendo un Acceptance Test con Visual Studio Code*), se elaboró **un archivo `.feature` por historia de usuario**, con keywords estándar de Gherkin (`Feature`, `Scenario Outline`, `Given/When/Then`, `Examples`) y **data tables** que definen los conjuntos de datos de entrada y los resultados esperados de cada escenario.

## Contenido

| Epic | Historias de usuario | Archivos |
|---|---|---|
| EP001 - Gestión de Accesos, Identidad y Perfiles | US001, US003 | `US001.feature`, `US003.feature` |
...
| EP004 - Reputación y Gamificación (NFR) | US024 | `US024.feature` |
| EP005 - Entregables y Comunicación | US025, US030 | `US025.feature`, `US030.feature` |
